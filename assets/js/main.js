...
(function ($) {
    ...
    // Filtrage et recherche des dons
    $(document).ready(function () {
        const searchInput = $("#search-input");
        const categoryFilter = $("#categorie-filter");
        const dons = $(".don-item");
        ...
        function filterDons() {
            ...
            dons.each(function () {
                const title = $(this).data("titre").toLowerCase();
                const category = $(this).data("categorie").toLowerCase();
        ...
        searchInput.on("input", filterDons);
        categoryFilter.on("change", filterDons);

        // Gestion des boutons de demande
        $('.request-donation').on('click', function () {
            const donId = $(this).data('don-id');
            console.log("Don ID envoyé :", donId);
