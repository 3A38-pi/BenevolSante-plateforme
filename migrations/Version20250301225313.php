 ...
 */
final class Version20250301225313 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE response_evaluation CHANGE rating rating INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE response_evaluation CHANGE rating rating DOUBLE PRECISION DEFAULT NULL');
    }
}
