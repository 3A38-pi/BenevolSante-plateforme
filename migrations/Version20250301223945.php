 ...
 */
final class Version20250301223945 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evaluation_response CHANGE answer answer LONGTEXT DEFAULT NULL, CHANGE rating rating INT DEFAULT NULL, CHANGE question_id evaluation_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE evaluation_response CHANGE answer answer VARCHAR(255) NOT NULL, CHANGE rating rating DOUBLE PRECISION DEFAULT NULL, CHANGE evaluation_id question_id INT NOT NULL');
